    ...
    switch (IJTYPE) {
        ...
        case 3:
        {
            ...
            if (KLMNBx == 3) {
                ...
                angularL[1] = (int) LOC3(devTrans, KLMNAx, KLMNAx+1, KLMNAx+1, TRANSDIM, TRANSDIM, TRANSDIM);
                angularL[2] = (int) LOC3(devTrans, KLMNAx+1, KLMNAx, KLMNAx+1, TRANSDIM, TRANSDIM, TRANSDIM);
                angularL[3] = (int) LOC3(devTrans, KLMNAx+1, KLMNAx+1, KLMNAx, TRANSDIM, TRANSDIM, TRANSDIM);
                angularL[4] = (int) LOC3(devTrans, KLMNAx, KLMNAx, KLMNAx+1, TRANSDIM, TRANSDIM, TRANSDIM);
                angularL[5] = (int) LOC3(devTrans, KLMNAx, KLMNAx+1, KLMNAx, TRANSDIM, TRANSDIM, TRANSDIM);
                angularL[6] = (int) LOC3(devTrans, KLMNAx+1, KLMNAx, KLMNAx, TRANSDIM, TRANSDIM, TRANSDIM);
