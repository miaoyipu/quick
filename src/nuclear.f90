...
subroutine nuclearattra(Ips,Jps,IIsh,JJsh,NIJ1, &
  ...
  do Iang=quick_basis%Qstart(IIsh),quick_basis%Qfinal(IIsh) 
     X1temp=gccoeff(ips,quick_basis%ksumtype(IIsh)+Iang)
     do Jang=quick_basis%Qstart(JJsh),quick_basis%Qfinal(JJsh)
        ...
        do III=III1,III2
           ...
           do JJJ=max(III,JJJ1),JJJ2
              ...
              quick_qm_struct%o(JJJ,III)=quick_qm_struct%o(JJJ,III)+Xconstant*cons(III)*cons(JJJ)*attraxiao(itemp1,itemp2,0)
     ...
     do Jang=quick_basis%Qstart(JJsh),quick_basis%Qfinal(JJsh)
        ...
        do III=III1,III2
           ...
           do JJJ=max(III,JJJ1),JJJ2
              ...
              itemp2=trans(KLMN(1,JJJ),KLMN(2,JJJ),KLMN(3,JJJ))
              quick_qm_struct%Eel=quick_qm_struct%Eel+DENSEJI*Xconstant*cons(III)*cons(JJJ)* &
        ...
        Do III=III1,III2
           ...
           Do JJJ=max(III,JJJ1),JJJ2
              ...
              Agrad1=Agrad1+2.0d0*Xconstant2* &
                   gcexpo(ips,quick_basis%ksumtype(IIsh))*attraxiao(itemp1new,itemp2,0)
              ...
              Bgrad1=Bgrad1+2.0d0*Xconstant2* &
                   gcexpo(jps,quick_basis%ksumtype(JJsh))*attraxiao(itemp1,itemp2new,0)
