...
! Be careful of coeff
! nuclearspdf.f90
subroutine nuclearattra(Ips,Jps,IIsh,JJsh,NIJ1, &
     Ax,Ay,Az,Bx,By,Bz,Cx,Cy,Cz,Px,Py,Pz,iatom)
  use allmod

  implicit double precision(a-h,o-z)

  real*8 attra,aux(0:20)
  integer a(3),b(3)
  ...
  case(10)
     call PSattra(0)
     !                             itemp1=trans(a(1),a(2),a(3))
     !                             itemp2=trans(b(1),b(2),b(3))
     !                             attra=attraxiao(itemp1,1,0)
  case(1)
     call SPattra(0)
     !                             itemp1=trans(a(1),a(2),a(3))
     !                             itemp2=trans(b(1),b(2),b(3))
     !                             attra=attraxiao(1,itemp2,0)
  case(11)
     ...
     !                             do ixiao=2,4
     !                               call PSattra(0,a(1:3),Mcal(1:3,1))
     !                               call PSattra(1,a(1:3),Mcal(1:3,1))
     !                             enddo
     ...
     call PSattra(1)
     call PPattra(0)
     !                             attra=attraxiao(itemp1,itemp2,0)      

  case(20)

     !                             do ixiao=1,3
     !                               if(a(ixiao).ne.0)then
     !                                 a(ixiao)=a(ixiao)-1
     !                                 itemp1=trans(a(1),a(2),a(3))
     !                                 call PSattra(0,Mcal(1:3,itemp1),Mcal(1:3,1))
     !                                 call PSattra(1,Mcal(1:3,itemp1),Mcal(1:3,1))
     !                                 a(ixiao)=a(ixiao)+1
     !                                 goto 111
     !                               endif
     !                             enddo
  ...
  case(2)
     ...
     !                             do ixiao=1,3
     !                               if(b(ixiao).ne.0)then
     !                                 b(ixiao)=b(ixiao)-1
     !                                 itemp1=trans(b(1),b(2),b(3))
     !                                 call SPattra(0,Mcal(1:3,1),Mcal(1:3,itemp1))
     !                                 call SPattra(1,Mcal(1:3,1),Mcal(1:3,itemp1))
     !                                 b(ixiao)=b(ixiao)+1
     !                                 goto 222
     !                               endif
     !                             enddo
  ...
  case(21)
     ...
     !                             do ixiao=2,4
     !                               call PSattra(0,Mcal(1:3,ixiao),Mcal(1:3,1))
     !                               call PSattra(1,Mcal(1:3,ixiao),Mcal(1:3,1))
     !                               call PSattra(2,Mcal(1:3,ixiao),Mcal(1:3,1))
     !                             enddo
     !
     !                             itemp1=trans(a(1),a(2),a(3))
     !!                             itemp2=trans(b(1),b(2),b(3))
     !                             
     !                             call DSattra(0,Mcal(1:3,itemp1),Mcal(1:3,1))
     !                             call DSattra(1,Mcal(1:3,itemp1),Mcal(1:3,1))
     !
  ...
  case(12)
     ...
     !                             do ixiao=2,4
     !                               call SPattra(0,Mcal(1:3,1),Mcal(1:3,ixiao))
     !                               call SPattra(1,Mcal(1:3,1),Mcal(1:3,ixiao))
     !                               call SPattra(2,Mcal(1:3,1),Mcal(1:3,ixiao))
     !                             enddo
     !
     !!                             itemp1=trans(a(1),a(2),a(3))
     !                             itemp2=trans(b(1),b(2),b(3))
     !
     !                             call SDattra(0,Mcal(1:3,1),Mcal(1:3,itemp2))
     !                             call SDattra(1,Mcal(1:3,1),Mcal(1:3,itemp2))
     !
  ...
  case(22)
     ...
     !                               call PSattra(1,Mcal(1:3,ixiao),Mcal(1:3,1))
     !                               call PSattra(2,Mcal(1:3,ixiao),Mcal(1:3,1))
     !                               call PSattra(3,Mcal(1:3,ixiao),Mcal(1:3,1))
     !                             enddo
     ! 
     !                             do ixiao=2,4
     !                               do jxiao=2,4
     ...
     !                             call DSattra(0,Mcal(1:3,itemp1),Mcal(1:3,1))
     !                             call DSattra(1,Mcal(1:3,itemp1),Mcal(1:3,1))
     !                             call DSattra(2,Mcal(1:3,itemp1),Mcal(1:3,1))
     !
  ...
  !                                if(iatom.eq.2.and.ips.eq.2.and.jps.eq.2)then
  !!                                  call SPattra(0)
  !!                                  print*,attraxiao(1,2,0),(PP(1)-BB(1))*(aux(0)),(PP(1)-CC(1))*(aux(1))
  !                                  print*,NIJ1,attraxiao(1,1,0),attraxiao(1,2,0),attraxiao(1,3,0),attraxiao(1,4,0), &
  !                                        aux(0),aux(1),PP(1)-CC(1)
  ...
  !           write(*,'(I2,I2,I2,I2)')Qstart(IIsh),Qfinal(IIsh), &
  !                Qstart(JJsh),Qfinal(JJsh)

  do Iang=Qstart(IIsh),Qfinal(IIsh) 
     X1temp=gccoeff(ips,ksumtype(IIsh)+Iang)
     do Jang=Qstart(JJsh),Qfinal(JJsh)
        NBI1=Qsbasis(IIsh,Iang)
        NBI2=Qfbasis(IIsh,Iang)
        NBJ1=Qsbasis(JJsh,Jang)
        NBJ2=Qfbasis(JJsh,Jang)

        III1=Ksumtype(IIsh)+NBI1
        III2=Ksumtype(IIsh)+NBI2
        JJJ1=Ksumtype(JJsh)+NBJ1
        JJJ2=Ksumtype(JJsh)+NBJ2

        Xconstant=X1temp*gccoeff(jps,ksumtype(JJsh)+Jang)
        do III=III1,III2
           ...
           do JJJ=max(III,JJJ1),JJJ2
              ...
              O(JJJ,III)=O(JJJ,III)+Xconstant*cons(III)*cons(JJJ)*attraxiao(itemp1,itemp2,0)

              !                                if(iatom.eq.1.and.ips.eq.1.and.jps.eq.1.and.III.eq.3)then
!!!                                  call SPattra(0)
!!!                                  print*,attraxiao(1,2,0),(PP(1)-BB(1))*(aux(0)),(PP(1)-CC(1))*(aux(1))
              !                                  print*,JJJ, &
              !                       Xconstant*cons(III)*cons(JJJ)*attraxiao(itemp1,itemp2,0)
              !!                                        aux(0),aux(1),PP(1)-CC(1)
              !                                  if(Jbas.eq.nbasis)then
              !                                  stop
              !                                  endif
              !                                endif
           enddo
...
subroutine PPattra(mtemp)
  ...
  !     itemp=trans(a(1),a(2),a(3))
  !     jtemp=trans(b(1),b(2),b(3))
     ...
     do Jang=Qstart(JJsh),Qfinal(JJsh)
        ...
        do III=III1,III2
           ...
           do JJJ=max(III,JJJ1),JJJ2
              ...
              itemp2=trans(KLMN(1,JJJ),KLMN(2,JJJ),KLMN(3,JJJ))
              Eel=Eel+DENSEJI*Xconstant*cons(III)*cons(JJJ)* &
...
subroutine nuclearattraopt(Ips,Jps,IIsh,JJsh,NIJ1, &
  ...
  Do Iang=Qstart(IIsh),Qfinal(IIsh) 
     ...
     Do Jang=Qstart(JJsh),Qfinal(JJsh)
        ...
        Do III=III1,III2
           Xconstant1=Xconstant*cons(III)
           itemp1=trans(KLMN(1,III),KLMN(2,III),KLMN(3,III))
           Do JJJ=max(III,JJJ1),JJJ2
              DENSEJI=DENSE(JJJ,III)
              if(III.ne.JJJ)DENSEJI=2.0d0*DENSEJI
              Xconstant2=Xconstant1*cons(JJJ)*DENSEJI
              itemp2=trans(KLMN(1,JJJ),KLMN(2,JJJ),KLMN(3,JJJ))
              !                                O(JJJ,III)=O(JJJ,III)+Xconstant*cons(III)*cons(JJJ)*attraxiao(itemp1,itemp2,0)
              ...
              itemp1new=trans(KLMN(1,III)+1,KLMN(2,III),KLMN(3,III))
              Agrad1=Agrad1+2.0d0*Xconstant2* &
                   gcexpo(ips,ksumtype(IIsh))*attraxiao(itemp1new,itemp2,0)
              if(KLMN(1,III).ge.1)then
                 itemp1new=trans(KLMN(1,III)-1,KLMN(2,III),KLMN(3,III))
                 Agrad1=Agrad1-Xconstant2* &
                      KLMN(1,III)*attraxiao(itemp1new,itemp2,0)
              endif

              itemp1new=trans(KLMN(1,III),KLMN(2,III)+1,KLMN(3,III))
              Agrad2=Agrad2+2.0d0*Xconstant2* &
                   gcexpo(ips,ksumtype(IIsh))*attraxiao(itemp1new,itemp2,0)
              if(KLMN(2,III).ge.1)then
                 itemp1new=trans(KLMN(1,III),KLMN(2,III)-1,KLMN(3,III))
                 Agrad2=Agrad2-Xconstant2* &
                      KLMN(2,III)*attraxiao(itemp1new,itemp2,0)
              endif

              itemp1new=trans(KLMN(1,III),KLMN(2,III),KLMN(3,III)+1)
              Agrad3=Agrad3+2.0d0*Xconstant2* &
                   gcexpo(ips,ksumtype(IIsh))*attraxiao(itemp1new,itemp2,0)
              if(KLMN(3,III).ge.1)then
                 itemp1new=trans(KLMN(1,III),KLMN(2,III),KLMN(3,III)-1)
                 Agrad3=Agrad3-Xconstant2* &
                      KLMN(3,III)*attraxiao(itemp1new,itemp2,0)
              endif

              itemp2new=trans(KLMN(1,JJJ)+1,KLMN(2,JJJ),KLMN(3,JJJ))
              Bgrad1=Bgrad1+2.0d0*Xconstant2* &
                   gcexpo(jps,ksumtype(JJsh))*attraxiao(itemp1,itemp2new,0)
              if(KLMN(1,JJJ).ge.1)then
                 itemp2new=trans(KLMN(1,JJJ)-1,KLMN(2,JJJ),KLMN(3,JJJ))
                 Bgrad1=Bgrad1-Xconstant2* &
                      KLMN(1,JJJ)*attraxiao(itemp1,itemp2new,0)
              endif

              itemp2new=trans(KLMN(1,JJJ),KLMN(2,JJJ)+1,KLMN(3,JJJ))
              Bgrad2=Bgrad2+2.0d0*Xconstant2* &
                   gcexpo(jps,ksumtype(JJsh))*attraxiao(itemp1,itemp2new,0)
              if(KLMN(2,JJJ).ge.1)then
                 itemp2new=trans(KLMN(1,JJJ),KLMN(2,JJJ)-1,KLMN(3,JJJ))
                 Bgrad2=Bgrad2-Xconstant2* &
                      KLMN(2,JJJ)*attraxiao(itemp1,itemp2new,0)
              endif

              itemp2new=trans(KLMN(1,JJJ),KLMN(2,JJJ),KLMN(3,JJJ)+1)
              Bgrad3=Bgrad3+2.0d0*Xconstant2* &
                   gcexpo(jps,ksumtype(JJsh))*attraxiao(itemp1,itemp2new,0)
              if(KLMN(3,JJJ).ge.1)then
                 itemp2new=trans(KLMN(1,JJJ),KLMN(2,JJJ),KLMN(3,JJJ)-1)
                 Bgrad3=Bgrad3-Xconstant2* &
                      KLMN(3,JJJ)*attraxiao(itemp1,itemp2new,0)
              endif


              !                               if(iatom.eq.2.and.ips.eq.1.and.jps.eq.1.and.III.eq.3)then
!!!                                  call SPattra(0)
!!!                                  print*,attraxiao(1,2,0),(PP(1)-BB(1))*(aux(0)),(PP(1)-CC(1))*(aux(1))
              !                                  print*,JJJ,KLMN(1,JJJ)+KLMN(2,JJJ)+KLMN(3,JJJ), &
              !                       Xconstant*cons(III)*cons(JJJ),Xconstant*cons(III)*cons(JJJ)*attraxiao(itemp1,itemp2,0)
              !!                                        aux(0),aux(1),PP(1)-CC(1)
              !                                  if(Jbas.eq.nbasis)then
              !                                  stop
              !                                  endif
