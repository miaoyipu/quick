...
!  First, calculate the angular points and weights.
       ...
       If(iattype(iitype).eq.1.or.iattype(iitype).eq.3)then
           if(ILEB.le.6)then
             CALL LD0006(XANG,YANG,ZANG,WTANG,N)
             iiang=6
...
!  First, calculate the angular points and weights.
       ...
       If(iattype(iitype).ge.1.and.iattype(iitype).le.2)then
       ...
       If(iattype(iitype).ge.3.and.iattype(iitype).le.10)then
       ...
       If(iattype(iitype).ge.11.and.iattype(iitype).le.18)then
